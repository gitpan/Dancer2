...
$Dancer2::Config::VERSION = '0.153001';
__END__
...
It's possible to set the configuration directory and environment directory
using this two environment variables. Setting B<DANCER_CONFDIR> will have
the same effect as doing
