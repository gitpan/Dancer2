...
B<WARNING> : Issuing a forward will B<NOT> exits the current
route. Unlike with Dancer 1, in Dancer 2 you need to explicitly return
from the route. This keeps up with the behavior of C<redirect>.
